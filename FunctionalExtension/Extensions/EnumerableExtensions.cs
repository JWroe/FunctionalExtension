...
namespace FunctionalExtension
{
    public static partial class F
    {
        ...
        public static IEnumerable<R> FlatMap<T, R>(this IEnumerable<T> ts, Func<T, IEnumerable<R>> f) =>
            ts.SelectMany(f);

        public static IEnumerable<R> FlatMap<T, R>(this IEnumerable<T> list, Func<T, Option<R>> func) =>
            list.FlatMap(t => func(t).AsEnumerable());
