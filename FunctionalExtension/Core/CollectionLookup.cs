...
namespace FunctionalExtension.Core
{
    public static partial class F
    {
        ...
        public static Option<TVal> Lookup<TKey, TVal>(this IDictionary<TKey, TVal> dict, TKey key) where TKey : struct => dict.TryGetValue(key, out var value) ? Some(value).AsOption() : None();
